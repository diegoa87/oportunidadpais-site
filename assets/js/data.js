...
const DATA = {
  ...
  personas: [
    ...
    },
    {
      ...
      name: 'Próximamente',
      role: 'Capítulo en producción',
      org: 'Desafío Latam',
      industry: 'negocios',
      city: 'Por anunciar',
      bio: 'El capítulo 10 está en producción. Publicación estimada Q4 2026.',
      keyIdea: 'Próximamente.',
      whyKnow: 'El episodio 10 está actualmente en producción.',
      chapterNum: 10,
      tone: 3,
      photoUrl: 'https://i.pravatar.cc/600?u=proximamente-10',
      linkedinUrl: '#',
      gender: 'm'
    },
    {
      slug: 'proximamente-11',
      name: 'Próximamente',
      role: 'Capítulo en producción',
      org: 'Desafío Latam',
      industry: 'energia',
      city: 'Por anunciar',
      bio: 'El capítulo 11 está en producción. Publicación estimada Q4 2026.',
      keyIdea: 'Próximamente.',
      whyKnow: 'El episodio 11 está actualmente en producción.',
      chapterNum: 11,
      tone: 4,
      photoUrl: 'https://i.pravatar.cc/600?u=proximamente-11',
      linkedinUrl: '#',
      gender: 'm'
    },
    {
      slug: 'proximamente-12',
      name: 'Próximamente',
      role: 'Capítulo en producción',
      org: 'Desafío Latam',
      industry: 'inclusion',
      city: 'Por anunciar',
      bio: 'El capítulo 12 está en producción. Publicación estimada Q4 2026.',
      keyIdea: 'Próximamente.',
      whyKnow: 'El episodio 12 está actualmente en producción.',
      chapterNum: 12,
      tone: 1,
      photoUrl: 'https://i.pravatar.cc/600?u=proximamente-12',
      linkedinUrl: '#',
      gender: 'm'
    }
  ],
  ...
  capitulos: [
    {
      num: 12,
      title: "Capítulo en producción.",
      personaSlug: 'proximamente-12',
      industry: 'inclusion',
      duration: 'Próximamente',
      date: '2026-09-03',
      tone: 1,
      spotifyUrl: 'https://open.spotify.com/show/2nGzjakwUUOf7AAqui0TnQ',
      shareText: 'Pronto: nuevo capítulo de Oportunidad País. Cap 12.'
    },
    {
      num: 11,
      title: "Capítulo en producción.",
      personaSlug: 'proximamente-11',
      industry: 'energia',
      duration: 'Próximamente',
      date: '2026-08-20',
      tone: 2,
      spotifyUrl: 'https://open.spotify.com/show/2nGzjakwUUOf7AAqui0TnQ',
      shareText: 'Pronto: nuevo capítulo de Oportunidad País. Cap 11.'
    },
    {
      num: 10,
      title: "Capítulo en producción.",
      personaSlug: 'proximamente-10',
      industry: 'negocios',
      duration: 'Próximamente',
      date: '2026-08-06',
      tone: 3,
      spotifyUrl: 'https://open.spotify.com/show/2nGzjakwUUOf7AAqui0TnQ',
      shareText: 'Pronto: nuevo capítulo de Oportunidad País. Cap 10.'
    },
    {
      num: 9,
